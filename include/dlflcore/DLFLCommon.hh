...
/*
  ...
  Iterators pointing to the deleted index and to the last element are
  invalidated. Relative ordering of iterators is also changed for index, last
  element and adjacent nodes.
*/

template <class T, class Alloc>
inline void remove(vector<T, Alloc> &array,
                   typename vector<T, Alloc>::size_type index) {
