...
/* Find the optimal axial projection plane for a polygon with the specified
 * normal vector Return value: 0 = YZ, 1 = ZX, 2 = XY (corresponding to vector
...
// Rotate the given polygon about it's centroid such tat normal goes to new
// direction
...
void rotateAroundVector(const Vector3d &axis, const double &angle,
                        const bool &ckeckAxisIsUnit, Vector3d &vectorToRotate);
void rotateAroundVector(const Vector3d &axis, const double &angle,
                        const bool &ckeckAxisIsUnit,
                        vector<Vector3d> &vectorsToRotate);
...
// angles The distances are from the centroid
...
void angleBisectorIntersection(const Vector3d &p0, const Vector3d &p1,
                               const Vector3d &p2,
                               Vector3d &angleBisectorIntersection);
// In a triangle created by verticies p0, p1 and p2, this function returns the
// intersection of angle bisectors
void angleBisectorCenter(const Vector3d &p0, const Vector3d &p1,
                         const Vector3d &p2, Vector3d &angleBisectorCenter);
...
// Returns a color
Vector3d computeLighting(const Vector3d& p, const Vector3d& n, const RGBColor&
basecolor, double Ka, double Kd, double Ks, LightPtr lightptr);
*/
