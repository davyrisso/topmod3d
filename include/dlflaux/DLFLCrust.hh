...
void createWireframeWithSegments(DLFLObjectPtr obj, double thickness = 0.1,
                                 int numSides = 4);
...
void selectFacesByArea(DLFLObjectPtr obj, DLFLFacePtr fptr,
                       DLFLFacePtrArray &fparray, float delta = 0.1);
void selectFacesByColor(DLFLObjectPtr obj, DLFLFacePtr fptr,
                        DLFLFacePtrArray &fparray, float delta = 0.0);
void punchHoles(DLFLObjectPtr obj);
void makeWireframe(DLFLObjectPtr obj, double crust_thickness = 0.1,
                   bool split = true);
void makeWireframe2(DLFLObjectPtr obj, double crust_thickness = 0.1,
                    double crust_width = 0.1, bool split = true);
