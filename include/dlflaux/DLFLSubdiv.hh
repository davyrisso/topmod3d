...
bool dooSabinSubdivide(DLFLObjectPtr obj,
                       bool check = true /*,QProgressDialog *progress = 0*/);
...
// Face Subdivision
void subdivideFace(DLFLObjectPtr obj, DLFLFacePtr faceptr,
                   bool usequads = true);
...
void subdivideFaces(DLFLObjectPtr obj, DLFLFacePtrArray fparray,
                    bool usequads = true);
void subdivideFaces(DLFLObjectPtr obj, DLFLFacePtrList fplist,
                    bool usequads = true);
