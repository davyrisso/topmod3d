...
public:
  ...
  void set(const Vector3d &start, const Vector3d &normal_s, const Vector3d &end,
           const Vector3d &normal_e, const double &rotation_angle);
  bool isValid() const;
...
protected:
  ...
  Vector3d point_at_start, point_at_end, normal_at_start, normal_at_end,
      rotation_axis;
