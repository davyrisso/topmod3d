...
public:
  ...
  PatchRenderer(QColor wc, double wt, QColor sc, double st, QColor vc,
  ...
  virtual void drawPatchOverlays(TMPatchObjectPtr patch_object) {
    ...
    if (TMPatchObject::GetRenderIncludesPatchEdges()) {
    ...
    if (TMPatch::GetShowControlMesh()) {
      glColor3d(0.0, 0.0, 0.0);
      glLineWidth(3.0);
      glDepthRange(0.0, 1.0 - 0.00055);
      patch_object->renderControlMeshInternalEdges();
      glColor3d(1.0, 0.0, 0.0);
      glLineWidth(3.0);
      glDepthRange(0.0, 1.0 - 0.00055);
      patch_object->renderControlMeshExternalEdges();
    }

    if (TMPatchObject::GetRenderIncludesModifiedDooSabinPolygons()) {
      // glColor3d(1.0,0.2,0.2);
      glColor3d(0.2, 0.2, 1.0);
      glLineWidth(2.0);
      glDepthRange(0.0, 1.0 - 0.00055);
      patch_object->renderModifiedDooSabinPolygons();
    }

    if (TMPatchObject::GetRenderIncludesDooSabinPolygons()) {
      glColor3d(0.2, 0.2, 1.0);
      glLineWidth(2.0);
      glDepthRange(0.0, 1.0 - 0.00055);
      patch_object->renderDooSabinPolygons();
    }
