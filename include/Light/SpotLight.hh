...
public:
  ...
  double getCutoff(void) const { return cutoff; }
  ...
  // Type of light
  virtual LightType type(void) const { return Spot; }

  // Does this light illuminate given point?
  // If dist of point is within spot light radius on the ZX plane SpotLight
  // illuminates
  ...
  // Illuminate a given point with a given normal using this light and return
  // color
