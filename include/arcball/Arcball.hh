...
protected:
  ...
  static Vector3d mouseOnSphere(const Vector3d &mouse, const Vector3d &center,
                                double radius);
  static Vector3d constrainToAxis(const Vector3d &loose, const Vector3d &axis);
  static int nearestConstraintAxis(const Vector3d &loose, Vector3d *axes,
                                   int nAxes);
  static Quaternion quatFromBallPoints(const Vector3d &from,
                                       const Vector3d &to);
  static void quatToBallPoints(const Quaternion &q, Vector3d &arcFrom,
                               Vector3d &arcTo);
