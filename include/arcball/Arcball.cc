...
static void glVertexV3(const Vector3d &pt) { glVertex3f(pt[0], pt[1], pt[2]); }
...
*/
Vector3d Arcball ::mouseOnSphere(const Vector3d &mouse, const Vector3d &center,
                                 double radius) {
  Vector3d ballMouse;
...
*/
Quaternion Arcball ::quatFromBallPoints(const Vector3d &from,
                                        const Vector3d &to) {
...
*/
void Arcball ::quatToBallPoints(const Quaternion &q, Vector3d &arcFrom,
                                Vector3d &arcTo) {
  double s;
...
*/
Vector3d Arcball ::constrainToAxis(const Vector3d &loose,
                                   const Vector3d &axis) {
  Vector3d onPlane;
  register float norm;
...
*/
int Arcball ::nearestConstraintAxis(const Vector3d &loose, Vector3d *axes,
                                    int nAxes) {
  Vector3d onPlane;
