...
int TLI_stringdec(char *string, char *kop, char *staart,
                  unsigned short *numlen);
void TLI_stringenc(char *string, char *kop, char *staart, unsigned short numlen,
                   int pic);
void TLI_addhead(struct ListBase *listbase, void *vlink);
void TLI_insertlinkbefore(struct ListBase *listbase, void *vnextlink,
                          void *vnewlink);
...
struct ListBase *TLI_listbase_from_dlist(struct DynamicList *dlist,
                                         struct ListBase *lb);
...
void *TLI_dlist_add_item_index(struct DynamicList *dlist, void *item,
                               unsigned int index);
...
#define PRINT2(t1, v1, t2, v2)                                                 \
  {                                                                            \
    PRNTSUB(t1, v1);                                                           \
    PRNTSUB(t2, v2);                                                           \
    printf("\n");                                                              \
  }
#define PRINT3(t1, v1, t2, v2, t3, v3)                                         \
  {                                                                            \
    PRNTSUB(t1, v1);                                                           \
    PRNTSUB(t2, v2);                                                           \
    PRNTSUB(t3, v3);                                                           \
...
#define PRINT4(t1, v1, t2, v2, t3, v3, t4, v4)                                 \
  {                                                                            \
    PRNTSUB(t1, v1);                                                           \
    PRNTSUB(t2, v2);                                                           \
    PRNTSUB(t3, v3);                                                           \
