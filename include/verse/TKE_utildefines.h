...
/* also fill in structs itself, dna cannot handle defines, duplicate in
 * blendef.h still */
#ifndef FILE_MAXDIR
...
#define ELEM7(a, b, c, d, e, f, g, h)                                          \
  (ELEM3(a, b, c, d) || ELEM4(a, e, f, g, h))
#define ELEM8(a, b, c, d, e, f, g, h, i)                                       \
...
#define MINSIZE(val, size)                                                     \
  (((val) >= 0.0) ? (((val) < (size)) ? (size) : (val))                        \
                  : (((val) > (-size)) ? (-size) : (val)))
...
#define LONGCOPY(a, b, c)                                                      \
  {                                                                            \
    int lcpc = c, *lcpa = (int *)a, *lcpb = (int *)b;                          \
    while (lcpc-- > 0)                                                         \
      *(lcpa++) = *(lcpb++);                                                   \
  }
