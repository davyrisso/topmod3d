 ...
 *
 */
ExtrusionsMode::ExtrusionsMode(QWidget *parent, QShortcutManager *sm,
                               QWidget *actionList)
    : QWidget(parent) {
  setParent(0);
  mParent = parent;
  ...
  mDooSabinExtrudeAction =
      new QAction(QIcon(":images/extrude_doosabin.png"), tr("Doo Sabin"), this);
  ...
  connect(mDooSabinExtrudeAction, SIGNAL(triggered()), this,
          SLOT(triggerDooSabinExtrude()));
  actionList->addAction(mDooSabinExtrudeAction);

  mCubicalExtrudeAction =
      new QAction(QIcon(":images/extrude_cubical.png"), tr("Cubical"), this);
  ...
  connect(mCubicalExtrudeAction, SIGNAL(triggered()), this,
          SLOT(triggerCubicalExtrude()));
  actionList->addAction(mCubicalExtrudeAction);

  mDodecahedralExtrudeAction = new QAction(
      QIcon(":images/extrude_dodecahedral.png"), tr("Dodecahedral"), this);
  ...
  mDodecahedralExtrudeAction->setStatusTip(
      tr("Enter Dodecahedral Extrude Mode"));
  mDodecahedralExtrudeAction->setToolTip(tr("Dodecahedral Extrude Mode"));
  connect(mDodecahedralExtrudeAction, SIGNAL(triggered()), this,
          SLOT(triggerDodecahedralExtrude()));
  actionList->addAction(mDodecahedralExtrudeAction);

  mIcosahedralExtrudeAction = new QAction(
      QIcon(":images/extrude_icosahedral.png"), tr("Icosahedral"), this);
  ...
  connect(mIcosahedralExtrudeAction, SIGNAL(triggered()), this,
          SLOT(triggerIcosahedralExtrude()));
  actionList->addAction(mIcosahedralExtrudeAction);

  mOctahedralExtrudeAction = new QAction(
      QIcon(":images/extrude_octahedral.png"), tr("Octahedral"), this);
  ...
  connect(mOctahedralExtrudeAction, SIGNAL(triggered()), this,
          SLOT(triggerOctahedralExtrude()));
  actionList->addAction(mOctahedralExtrudeAction);

  mStellateExtrudeAction =
      new QAction(QIcon(":images/extrude_stellate.png"), tr("Stellate"), this);
  ...
  connect(mStellateExtrudeAction, SIGNAL(triggered()), this,
          SLOT(triggerStellateExtrude()));
  actionList->addAction(mStellateExtrudeAction);

  mDoubleStellateExtrudeAction = new QAction(
      QIcon(":images/extrude_doublestellate.png"), tr("Double Stellate"), this);
  ...
  connect(mDoubleStellateExtrudeAction, SIGNAL(triggered()), this,
          SLOT(triggerDoubleStellateExtrude()));
  actionList->addAction(mDoubleStellateExtrudeAction);

  mDomeExtrudeAction =
      new QAction(QIcon(":images/extrude_dome.png"), tr("Dome"), this);
  ...
  connect(mDomeExtrudeAction, SIGNAL(triggered()), this,
          SLOT(triggerDomeExtrude()));
...
void ExtrusionsMode::addActions(QActionGroup *actionGroup, QToolBar *toolBar,
...
void ExtrusionsMode::triggerDooSabinExtrude() {
  ...
  ((MainWindow *)mParent)
      ->setSpinBoxes(dooSabinLengthSpinBox, dooSabinTwistSpinBox,
                     dooSabinScaleSpinBox, dooSabinSegmentsSpinBox);
}
...
void ExtrusionsMode::triggerCubicalExtrude() {
  ...
  ((MainWindow *)mParent)
      ->setSpinBoxes(cubicalLengthSpinBox, cubicalRotationSpinBox,
                     cubicalScaleSpinBox, cubicalSegmentsSpinBox);
}
...
void ExtrusionsMode::triggerDodecahedralExtrude() {
  ...
  ((MainWindow *)mParent)
      ->setSpinBoxes(dodecahedralLengthSpinBox, dodecahedralScaleSpinBox,
                     dodecahedralSegmentsSpinBox);
}
...
void ExtrusionsMode::triggerIcosahedralExtrude() {
  ...
  ((MainWindow *)mParent)
      ->setSpinBoxes(icosahedralLengthSpinBox, icosahedralScaleSpinBox,
                     icosahedralSegmentsSpinBox);
}
...
void ExtrusionsMode::triggerOctahedralExtrude() {
  ...
  ((MainWindow *)mParent)
      ->setSpinBoxes(octahedralLengthSpinBox, octahedralRotationSpinBox,
                     octahedralScaleSpinBox, octahedralSegmentsSpinBox);
}
...
void ExtrusionsMode::triggerDomeExtrude() {
  ...
  ((MainWindow *)mParent)
      ->setSpinBoxes(domeHeightSpinBox, domeRotationSpinBox, domeScaleSpinBox);
}
...
void ExtrusionsMode::setupDooSabinExtrude() {
  ...
  dooSabinLengthSpinBox =
      createDoubleSpinBox(mDooSabinExtrudeLayout, dooSabinLengthLabel,
                          tr("Length"), -100.0, 100.0, 0.1, 2.0, 3, 0, 0);
  connect(dooSabinLengthSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setLength(double)));
  // rotation
  dooSabinTwistLabel = new QLabel(this);
  dooSabinTwistSpinBox =
      createDoubleSpinBox(mDooSabinExtrudeLayout, dooSabinTwistLabel,
                          tr("Twist"), -5, 5, .01, 0.0, 3, 1, 0);
  connect(dooSabinTwistSpinBox, SIGNAL(valueChanged(double)),
          ((MainWindow *)mParent), SLOT(changeDooSabinExtrudeTwist(double)));
  // scale
  dooSabinScaleLabel = new QLabel(this);
  dooSabinScaleSpinBox =
      createDoubleSpinBox(mDooSabinExtrudeLayout, dooSabinScaleLabel,
                          tr("Scale"), 0.0, 10.0, 0.01, 1.0, 3, 2, 0);
  connect(dooSabinScaleSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setScale(double)));
  // segments
  dooSabinSegmentsLabel = new QLabel(this);
  dooSabinSegmentsSpinBox =
      createDoubleSpinBox(mDooSabinExtrudeLayout, dooSabinSegmentsLabel,
                          tr("Segments"), 1, 50, 1, 1, 0, 3, 0);
  connect(dooSabinSegmentsSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setSegments(double)));

  performDooSabinExtrusionButton =
      new QPushButton(tr("Extrude Selected Faces"), this);
  connect(performDooSabinExtrusionButton, SIGNAL(clicked()),
          ((MainWindow *)mParent), SLOT(performExtrusion()));
...
void ExtrusionsMode::setupCubicalExtrude() {
  ...
  cubicalLengthSpinBox =
      createDoubleSpinBox(mCubicalExtrudeLayout, cubicalLengthLabel,
                          tr("Length"), -100.0, 100.0, 0.1, 2.0, 3, 0, 0);
  connect(cubicalLengthSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setLength(double)));
  // rotation
  cubicalRotationLabel = new QLabel(this);
  cubicalRotationSpinBox =
      createDoubleSpinBox(mCubicalExtrudeLayout, cubicalRotationLabel,
                          tr("Rotation"), 0, 360, 1, 0.0, 3, 1, 0);
  connect(cubicalRotationSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setRotation(double)));
  // scale
  cubicalScaleLabel = new QLabel(this);
  cubicalScaleSpinBox =
      createDoubleSpinBox(mCubicalExtrudeLayout, cubicalScaleLabel, tr("Scale"),
                          0.0, 10.0, 0.01, 1.0, 3, 2, 0);
  connect(cubicalScaleSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setScale(double)));
  // segments
  cubicalSegmentsLabel = new QLabel(this);
  cubicalSegmentsSpinBox =
      createDoubleSpinBox(mCubicalExtrudeLayout, cubicalSegmentsLabel,
                          tr("Segments"), 1, 50, 1, 1, 0, 3, 0);
  connect(cubicalSegmentsSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setSegments(double)));

  performCubicalExtrusionButton =
      new QPushButton(tr("Extrude Selected Faces"), this);
  connect(performCubicalExtrusionButton, SIGNAL(clicked()),
          ((MainWindow *)mParent), SLOT(performExtrusion()));
  mCubicalExtrudeLayout->addWidget(performCubicalExtrusionButton, 4, 0, 1, 2);

  cubicalTriangulateNewFacesCheckBox =
  ...
  mCubicalExtrudeLayout->addWidget(cubicalTriangulateNewFacesCheckBox, 5, 0, 1,
                                   2);
  ...
  cubicalPinchSpinBox =
      createDoubleSpinBox(mCubicalExtrudeLayout, cubicalPinchLabel, tr("Pinch"),
                          -1, 10, 0.1, 1.0, 2, 7, 0);
  connect(cubicalPinchSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(ChangeScherkCollinsPinch(double)));

  QLabel *cubicalPinchCenterLabel = new QLabel(this);
  cubicalPinchCenterSpinBox =
      createDoubleSpinBox(mCubicalExtrudeLayout, cubicalPinchCenterLabel,
                          tr("Pinch Center"), 0.1, 1, 0.1, 0.5, 3, 8, 0);
  connect(cubicalPinchCenterSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(ChangeScherkCollinsPinchCenter(double)));

  QLabel *cubicalPinchWidthLabel = new QLabel(this);
  cubicalPinchWidthSpinBox =
      createDoubleSpinBox(mCubicalExtrudeLayout, cubicalPinchWidthLabel,
                          tr("Pinch Width"), 0.001, 10, 0.1, 1.0, 3, 9, 0);
  connect(cubicalPinchWidthSpinBox, SIGNAL(valueChanged(double)), this,
...
void ExtrusionsMode::setupDodecahedralExtrude() {
  ...
  // //length
  // dodecahedralLengthSpinBox = createDoubleSpinBox(mDodecahedralExtrudeLayout,
  // dodecahedralLengthLabel, tr("Length"), -100.0, 100.0, 0.1, 2.0, 1, 0,0);
  // connect(dodecahedralLengthSpinBox, SIGNAL(valueChanged(double)),this,
  // SLOT(setLength(double)));
  // length1
  dodecahedralLength1Label = new QLabel(this);
  dodecahedralLength1SpinBox =
      createDoubleSpinBox(mDodecahedralExtrudeLayout, dodecahedralLength1Label,
                          tr("Length 1"), 0.0, 100.0, 0.1, 0.5, 3, 0, 0);
  connect(dodecahedralLength1SpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setLength1(double)));
  // length2
  dodecahedralLength2Label = new QLabel(this);
  dodecahedralLength2SpinBox =
      createDoubleSpinBox(mDodecahedralExtrudeLayout, dodecahedralLength2Label,
                          tr("Length 2"), 0.0, 100.0, 0.1, 1.0, 3, 1, 0);
  connect(dodecahedralLength2SpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setLength2(double)));
  // length3
  dodecahedralLength3Label = new QLabel(this);
  dodecahedralLength3SpinBox =
      createDoubleSpinBox(mDodecahedralExtrudeLayout, dodecahedralLength3Label,
                          tr("Length 3"), 0.0, 100.0, 0.1, 1.0, 3, 2, 0);
  connect(dodecahedralLength3SpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setLength3(double)));
  // angle
  dodecahedralAngleLabel = new QLabel(this);
  dodecahedralAngleSpinBox =
      createDoubleSpinBox(mDodecahedralExtrudeLayout, dodecahedralAngleLabel,
                          tr("Angle"), 0.0, 180.0, 0.1, 40.0, 3, 3, 0);
  connect(dodecahedralAngleSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setAngle(double)));
  // //scale
  // dodecahedralScaleSpinBox = createDoubleSpinBox(mDodecahedralExtrudeLayout,
  // dodecahedralScaleLabel, tr("Scale"), 0.0, 10.0, 0.01, 1.0, 2, 1,0);
  // connect(dodecahedralScaleSpinBox, SIGNAL(valueChanged(double)),this,
  // SLOT(setScale(double)));
  // segments
  dodecahedralSegmentsLabel = new QLabel(this);
  dodecahedralSegmentsSpinBox =
      createDoubleSpinBox(mDodecahedralExtrudeLayout, dodecahedralSegmentsLabel,
                          tr("Segments"), 1, 50, 1, 1, 0, 4, 0);
  connect(dodecahedralSegmentsSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setSegments(double)));
  ...
  connect(hexagonalizeCheckBox, SIGNAL(stateChanged(int)),
          ((MainWindow *)mParent),
          SLOT(toggleHexagonalizeDodecaExtrudeFlag(int)));

  mDodecahedralExtrudeLayout->addWidget(hexagonalizeCheckBox, 5, 1);

  performDodecahedralExtrusionButton =
      new QPushButton(tr("Extrude Selected Faces"), this);
  connect(performDodecahedralExtrusionButton, SIGNAL(clicked()),
          ((MainWindow *)mParent), SLOT(performExtrusion()));
  mDodecahedralExtrudeLayout->addWidget(performDodecahedralExtrusionButton, 6,
                                        0, 1, 2);
...
void ExtrusionsMode::setupIcosahedralExtrude() {
  ...
  // icosahedralLengthLabel, tr("Length"), -100.0, 100.0, 0.1, 2.0, 1, 0,0);
  // connect(icosahedralLengthSpinBox, SIGNAL(valueChanged(double)),this,
  // SLOT(setLength(double)));
  // scale
  // icosahedralScaleSpinBox = createDoubleSpinBox(mIcosahedralExtrudeLayout,
  // icosahedralScaleLabel, tr("Scale"), 0.0, 10.0, 0.01, 1.0, 2, 1,0);
  // connect(icosahedralScaleSpinBox, SIGNAL(valueChanged(double)),this,
  // SLOT(setScale(double)));

  // length1
  icosahedralLength1Label = new QLabel(this);
  icosahedralLength1SpinBox =
      createDoubleSpinBox(mIcosahedralExtrudeLayout, icosahedralLength1Label,
                          tr("Length 1"), 0.0, 100.0, 0.1, 0.5, 3, 0, 0);
  connect(icosahedralLength1SpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setLength1Icosa(double)));
  // length2
  icosahedralLength2Label = new QLabel(this);
  icosahedralLength2SpinBox =
      createDoubleSpinBox(mIcosahedralExtrudeLayout, icosahedralLength2Label,
                          tr("Length 2"), 0.0, 100.0, 0.1, 0.7, 3, 1, 0);
  connect(icosahedralLength2SpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setLength2Icosa(double)));
  // length3
  icosahedralLength3Label = new QLabel(this);
  icosahedralLength3SpinBox =
      createDoubleSpinBox(mIcosahedralExtrudeLayout, icosahedralLength3Label,
                          tr("Length 3"), 0.0, 100.0, 0.1, 0.8, 3, 2, 0);
  connect(icosahedralLength3SpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setLength3Icosa(double)));
  // angle
  icosahedralAngleLabel = new QLabel(this);
  icosahedralAngleSpinBox =
      createDoubleSpinBox(mIcosahedralExtrudeLayout, icosahedralAngleLabel,
                          tr("Angle"), 0.0, 180.0, 0.1, 50.0, 3, 3, 0);
  connect(icosahedralAngleSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setAngleIcosa(double)));
  // segments
  icosahedralSegmentsLabel = new QLabel(this);
  icosahedralSegmentsSpinBox =
      createDoubleSpinBox(mIcosahedralExtrudeLayout, icosahedralSegmentsLabel,
                          tr("Segments"), 1, 50, 1, 1, 0, 4, 0);
  connect(icosahedralSegmentsSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setSegments(double)));

  performIcosahedralExtrusionButton =
      new QPushButton(tr("Extrude Selected Faces"), this);
  connect(performIcosahedralExtrusionButton, SIGNAL(clicked()),
          ((MainWindow *)mParent), SLOT(performExtrusion()));
  mIcosahedralExtrudeLayout->addWidget(performIcosahedralExtrusionButton, 5, 0,
                                       1, 2);
...
void ExtrusionsMode::setupOctahedralExtrude() {
  ...
  octahedralLengthSpinBox =
      createDoubleSpinBox(mOctahedralExtrudeLayout, octahedralLengthLabel,
                          tr("Length"), -100.0, 100.0, 0.1, 2.0, 3, 0, 0);
  connect(octahedralLengthSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setLength(double)));
  // rotation
  octahedralRotationLabel = new QLabel(this);
  octahedralRotationSpinBox =
      createDoubleSpinBox(mOctahedralExtrudeLayout, octahedralRotationLabel,
                          tr("Rotation"), 0, 360, 1, 0.0, 3, 1, 0);
  connect(octahedralRotationSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setRotation(double)));
  // scale
  octahedralScaleLabel = new QLabel(this);
  octahedralScaleSpinBox =
      createDoubleSpinBox(mOctahedralExtrudeLayout, octahedralScaleLabel,
                          tr("Scale"), 0.0, 10.0, 0.01, 1.0, 3, 2, 0);
  connect(octahedralScaleSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setScale(double)));
  // segments
  octahedralSegmentsLabel = new QLabel(this);
  octahedralSegmentsSpinBox =
      createDoubleSpinBox(mOctahedralExtrudeLayout, octahedralSegmentsLabel,
                          tr("Segments"), 1, 50, 1, 1, 0, 3, 0);
  connect(octahedralSegmentsSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setSegments(double)));
  // mesh flat edges checkbox
  ...
  performOctahedralExtrusionButton =
      new QPushButton(tr("Extrude Selected Faces"), this);
  connect(performOctahedralExtrusionButton, SIGNAL(clicked()),
          ((MainWindow *)mParent), SLOT(performExtrusion()));
  mOctahedralExtrudeLayout->addWidget(performOctahedralExtrusionButton, 5, 0, 1,
                                      2);
...
void ExtrusionsMode::setupStellateExtrude() {
  ...
  stellateLengthSpinBox =
      createDoubleSpinBox(mStellateExtrudeLayout, stellateLengthLabel,
                          tr("Length"), -100.0, 100.0, 0.1, 2.0, 3, 0, 0);
  connect(stellateLengthSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setLength(double)));

  performStellateExtrusionButton =
      new QPushButton(tr("Extrude Selected Faces"), this);
  connect(performStellateExtrusionButton, SIGNAL(clicked()),
          ((MainWindow *)mParent), SLOT(performExtrusion()));
...
void ExtrusionsMode::setupDoubleStellateExtrude() {
  ...
  doubleStellateLengthSpinBox = createDoubleSpinBox(
      mDoubleStellateExtrudeLayout, doubleStellateLengthLabel, tr("Length"),
      -100.0, 100.0, 0.1, 2.0, 3, 0, 0);
  connect(doubleStellateLengthSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(setLength(double)));

  performDoubleStellateExtrusionButton =
      new QPushButton(tr("Extrude Selected Faces"), this);
  connect(performDoubleStellateExtrusionButton, SIGNAL(clicked()),
          ((MainWindow *)mParent), SLOT(performExtrusion()));
  mDoubleStellateExtrudeLayout->addWidget(performDoubleStellateExtrusionButton,
                                          1, 0, 1, 2);
...
void ExtrusionsMode::setupDomeExtrude() {
  ...
  domeHeightSpinBox =
      createDoubleSpinBox(mDomeExtrudeLayout, domeHeightLabel, tr("Height:"),
                          -10.0, 100.0, 0.01, 1.0, 3, 0, 0);
  connect(domeHeightSpinBox, SIGNAL(valueChanged(double)),
          ((MainWindow *)mParent), SLOT(changeDomeExtrudeLength(double)));
  domeRotationLabel = new QLabel(this);
  domeRotationSpinBox =
      createDoubleSpinBox(mDomeExtrudeLayout, domeRotationLabel, tr("Twist:"),
                          -1.0, 1.0, 0.01, 0.0, 3, 1, 0);
  connect(domeRotationSpinBox, SIGNAL(valueChanged(double)),
          ((MainWindow *)mParent), SLOT(changeDomeExtrudeRotation(double)));
  domeScaleLabel = new QLabel(this);
  domeScaleSpinBox =
      createDoubleSpinBox(mDomeExtrudeLayout, domeScaleLabel, tr("Scale:"), 0.0,
                          10.0, 0.01, 1.0, 3, 2, 0);
  connect(domeScaleSpinBox, SIGNAL(valueChanged(double)),
          ((MainWindow *)mParent), SLOT(changeDomeExtrudeScale(double)));
