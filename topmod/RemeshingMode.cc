 ...
 * @param sm the shortcut manager class for adding a custom shortcut to each
 * menu action or icon
 * @param actionList the master list of actions for use with the
...
RemeshingMode::RemeshingMode(QWidget *parent, QShortcutManager *sm,
  ...
  mDualAction =
      new QAction(/*QIcon(":images/doosabin_extrude.png"),*/ tr("Dual"), this);
  ...
  mRootThreeAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Root-3"), this);
  ...
  connect(mRootThreeAction, SIGNAL(triggered()), this,
          SLOT(triggerRootThree()));
  actionList->addAction(mRootThreeAction);

  mTriangulateAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Triangulate"), this);
  ...
  connect(mTriangulateAction, SIGNAL(triggered()), this,
          SLOT(triggerTriangulate()));
  actionList->addAction(mTriangulateAction);

  mDualVertexTruncationAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Dual Vertex Truncation"),
      this);
  ...
  mDualVertexTruncationAction->setStatusTip(
      tr("Enter Dual Vertex Truncation Remeshing Mode"));
  mDualVertexTruncationAction->setToolTip(
      tr("Dual Vertex Truncation Remeshing Mode"));
  connect(mDualVertexTruncationAction, SIGNAL(triggered()), this,
          SLOT(triggerDualVertexTruncation()));
  actionList->addAction(mDualVertexTruncationAction);

  mStellationAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Stellate"), this);
  ...
  connect(mStellationAction, SIGNAL(triggered()), this,
          SLOT(triggerStellation()));
  actionList->addAction(mStellationAction);

  mDoubleStellationAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Double Stellate"), this);
  mDoubleStellationAction->setCheckable(true);
  sm->registerAction(mDoubleStellationAction, "Remeshing", "");
  mDoubleStellationAction->setStatusTip(
      tr("Enter Double Stellate Remeshing Mode"));
  mDoubleStellationAction->setToolTip(tr("Double Stellate Remeshing Mode"));
  connect(mDoubleStellationAction, SIGNAL(triggered()), this,
          SLOT(triggerDoubleStellation()));
  actionList->addAction(mDoubleStellationAction);

  mTwelveSixFourAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("12.6.4"), this);
  ...
  connect(mTwelveSixFourAction, SIGNAL(triggered()), this,
          SLOT(triggerTwelveSixFour()));
  actionList->addAction(mTwelveSixFourAction);

  mHoneycombAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Honeycomb"), this);
  ...
  connect(mHoneycombAction, SIGNAL(triggered()), this,
          SLOT(triggerHoneycomb()));
  actionList->addAction(mHoneycombAction);

  mVertexTruncationAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Vertex Truncation"), this);
  mVertexTruncationAction->setCheckable(true);
  sm->registerAction(mVertexTruncationAction, "Remeshing", "");
  mVertexTruncationAction->setStatusTip(
      tr("Enter Vertex Truncation Remeshing Mode"));
  mVertexTruncationAction->setToolTip(tr("Vertex Truncation Remeshing Mode"));
  connect(mVertexTruncationAction, SIGNAL(triggered()), this,
          SLOT(triggerVertexTruncation()));
  actionList->addAction(mVertexTruncationAction);

  mDualTwelveSixFourAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Dual 12.6.4"), this);
  mDualTwelveSixFourAction->setCheckable(true);
  sm->registerAction(mDualTwelveSixFourAction, "Remeshing", "");
  mDualTwelveSixFourAction->setStatusTip(
      tr("Enter Dual 12.6.4 Remeshing Mode"));
  mDualTwelveSixFourAction->setToolTip(tr("Dual 12.6.4 Remeshing Mode"));
  connect(mDualTwelveSixFourAction, SIGNAL(triggered()), this,
          SLOT(triggerDualTwelveSixFour()));
  actionList->addAction(mDualTwelveSixFourAction);

  mLinearVertexAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Linear Vertex Insertion"),
      this);
  mLinearVertexAction->setCheckable(true);
  sm->registerAction(mLinearVertexAction, "Remeshing", "");
  mLinearVertexAction->setStatusTip(
      tr("Enter Linear Vertex Insertion Remeshing Mode"));
  mLinearVertexAction->setToolTip(tr("Linear Vertex Insertion Remeshing Mode"));
  connect(mLinearVertexAction, SIGNAL(triggered()), this,
          SLOT(triggerLinearVertex()));
  actionList->addAction(mLinearVertexAction);

  mCatmullClarkAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Catmull Clark"), this);
  ...
  connect(mCatmullClarkAction, SIGNAL(triggered()), this,
          SLOT(triggerCatmullClark()));
  actionList->addAction(mCatmullClarkAction);

  mStellateEdgeRemovalAction =
      new QAction(/*QIcon(":images/doosabin_extrude.png"),*/ tr(
  ...
  mStellateEdgeRemovalAction->setStatusTip(
      tr("Enter Stellate with Edge Removal Remeshing Mode"));
  mStellateEdgeRemovalAction->setToolTip(
      tr("Stellate with Edge Removal Remeshing Mode"));
  connect(mStellateEdgeRemovalAction, SIGNAL(triggered()), this,
          SLOT(triggerStellateEdgeRemoval()));
  actionList->addAction(mStellateEdgeRemovalAction);

  mDooSabinAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Doo Sabin"), this);
  ...
  mCornerCuttingAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Corner Cutting"), this);
  ...
  connect(mCornerCuttingAction, SIGNAL(triggered()), this,
          SLOT(triggerCornerCutting()));
  actionList->addAction(mCornerCuttingAction);

  mModifiedCornerCuttingAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Modified Corner Cutting"),
      this);
  mModifiedCornerCuttingAction->setCheckable(true);
  sm->registerAction(mModifiedCornerCuttingAction, "Remeshing", "");
  mModifiedCornerCuttingAction->setStatusTip(
      tr("Enter Modified Corner Cutting Remeshing Mode"));
  mModifiedCornerCuttingAction->setToolTip(
      tr("Modified Corner Cutting Remeshing Mode"));
  connect(mModifiedCornerCuttingAction, SIGNAL(triggered()), this,
          SLOT(triggerModifiedCornerCutting()));
  actionList->addAction(mModifiedCornerCuttingAction);

  mSimplestAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Simplest"), this);
  ...
  mPentagonalizationAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Pentagonalization"), this);
  mPentagonalizationAction->setCheckable(true);
  sm->registerAction(mPentagonalizationAction, "Remeshing", "");
  mPentagonalizationAction->setStatusTip(
      tr("Enter Pentagonalization Remeshing Mode"));
  mPentagonalizationAction->setToolTip(tr("Pentagonalization Remeshing Mode"));
  connect(mPentagonalizationAction, SIGNAL(triggered()), this,
          SLOT(triggerPentagonalization()));
  actionList->addAction(mPentagonalizationAction);

  mCubicPentagonalizationAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Cubic Pentagonalization"),
      this);
  mCubicPentagonalizationAction->setCheckable(true);
  sm->registerAction(mCubicPentagonalizationAction, "Remeshing", "");
  mCubicPentagonalizationAction->setStatusTip(
      tr("Enter Cubic Pentagonalization Remeshing Mode"));
  mCubicPentagonalizationAction->setToolTip(
      tr("Cubic Pentagonalization Remeshing Mode"));
  connect(mCubicPentagonalizationAction, SIGNAL(triggered()), this,
          SLOT(triggerCubicPentagonalization()));
  actionList->addAction(mCubicPentagonalizationAction);

  mDualPentagonalizationAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Dual Pentagonalization"),
      this);
  mDualPentagonalizationAction->setCheckable(true);
  sm->registerAction(mDualPentagonalizationAction, "Remeshing", "");
  mDualPentagonalizationAction->setStatusTip(
      tr("Enter Dual Pentagonalization Remeshing Mode"));
  mDualPentagonalizationAction->setToolTip(
      tr("Dual Pentagonalization Remeshing Mode"));
  connect(mDualPentagonalizationAction, SIGNAL(triggered()), this,
          SLOT(triggerDualPentagonalization()));
  actionList->addAction(mDualPentagonalizationAction);

  mLoopStyleRemeshingAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Loop Style Remeshing"),
      this);
  mLoopStyleRemeshingAction->setCheckable(true);
  sm->registerAction(mLoopStyleRemeshingAction, "Remeshing", "");
  mLoopStyleRemeshingAction->setStatusTip(
      tr("Enter Loop Style Remeshing Remeshing Mode"));
  mLoopStyleRemeshingAction->setToolTip(
      tr("Loop Style Remeshing Remeshing Mode"));
  connect(mLoopStyleRemeshingAction, SIGNAL(triggered()), this,
          SLOT(triggerLoopStyleRemeshing()));
  actionList->addAction(mLoopStyleRemeshingAction);

  mLoopSubdivisionAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Loop Subdivision"), this);
  mLoopSubdivisionAction->setCheckable(true);
  sm->registerAction(mLoopSubdivisionAction, "Remeshing", "");
  mLoopSubdivisionAction->setStatusTip(
      tr("Enter Loop Subdivision Remeshing Mode"));
  mLoopSubdivisionAction->setToolTip(tr("Loop Subdivision Remeshing Mode"));
  connect(mLoopSubdivisionAction, SIGNAL(triggered()), this,
          SLOT(triggerLoopSubdivision()));
  actionList->addAction(mLoopSubdivisionAction);

  mDualLoopStyleRemeshingAction =
      new QAction(/*QIcon(":images/doosabin_extrude.png"),*/ tr(
  ...
  mDualLoopStyleRemeshingAction->setStatusTip(
      tr("Enter Dual Loop Style Remeshing Remeshing Mode"));
  mDualLoopStyleRemeshingAction->setToolTip(
      tr("Dual Loop Style Remeshing Remeshing Mode"));
  connect(mDualLoopStyleRemeshingAction, SIGNAL(triggered()), this,
          SLOT(triggerDualLoopStyleRemeshing()));
  actionList->addAction(mDualLoopStyleRemeshingAction);

  mDualLoopSubdivisionAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Dual Loop Subdivision"),
      this);
  mDualLoopSubdivisionAction->setCheckable(true);
  sm->registerAction(mDualLoopSubdivisionAction, "Remeshing", "");
  mDualLoopSubdivisionAction->setStatusTip(
      tr("Enter Dual Loop Subdivision Remeshing Mode"));
  mDualLoopSubdivisionAction->setToolTip(
      tr("Dual Loop Subdivision Remeshing Mode"));
  connect(mDualLoopSubdivisionAction, SIGNAL(triggered()), this,
          SLOT(triggerDualLoopSubdivision()));
  actionList->addAction(mDualLoopSubdivisionAction);

  mGlobalExtrudeAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Global Extrude"), this);
  ...
  connect(mGlobalExtrudeAction, SIGNAL(triggered()), this,
          SLOT(triggerGlobalExtrude()));
  actionList->addAction(mGlobalExtrudeAction);

  mCheckerboardAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Checkerboard"), this);
  ...
  connect(mCheckerboardAction, SIGNAL(triggered()), this,
          SLOT(triggerCheckerboard()));
  actionList->addAction(mCheckerboardAction);

  mDualGlobalExtrudeAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Dual Global Extrude"),
      this);
  mDualGlobalExtrudeAction->setCheckable(true);
  sm->registerAction(mDualGlobalExtrudeAction, "Remeshing", "");
  mDualGlobalExtrudeAction->setStatusTip(
      tr("Enter Dual Global Extrude Remeshing Mode"));
  mDualGlobalExtrudeAction->setToolTip(
      tr("Dual Global Extrude Remeshing Mode"));
  connect(mDualGlobalExtrudeAction, SIGNAL(triggered()), this,
          SLOT(triggerDualGlobalExtrude()));
  actionList->addAction(mDualGlobalExtrudeAction);

  mDualCheckerboardAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Dual Checkerboard"), this);
  mDualCheckerboardAction->setCheckable(true);
  sm->registerAction(mDualCheckerboardAction, "Remeshing", "");
  mDualCheckerboardAction->setStatusTip(
      tr("Enter Dual Checkerboard Remeshing Mode"));
  mDualCheckerboardAction->setToolTip(tr("Dual Checkerboard Remeshing Mode"));
  connect(mDualCheckerboardAction, SIGNAL(triggered()), this,
          SLOT(triggerDualCheckerboard()));
  actionList->addAction(mDualCheckerboardAction);

  mPentagonPreservingAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Pentagon Preserving"),
      this);
  mPentagonPreservingAction->setCheckable(true);
  sm->registerAction(mPentagonPreservingAction, "Remeshing", "");
  mPentagonPreservingAction->setStatusTip(
      tr("Enter Pentagon Preserving Remeshing Mode"));
  mPentagonPreservingAction->setToolTip(
      tr("Pentagon Preserving Remeshing Mode"));
  connect(mPentagonPreservingAction, SIGNAL(triggered()), this,
          SLOT(triggerPentagonPreserving()));
  actionList->addAction(mPentagonPreservingAction);

  mDualPentagonPreservingAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Dual Pentagon Preserving"),
      this);
  mDualPentagonPreservingAction->setCheckable(true);
  sm->registerAction(mDualPentagonPreservingAction, "Remeshing", "");
  mDualPentagonPreservingAction->setStatusTip(
      tr("Enter Dual Pentagon Preserving Remeshing Mode"));
  mDualPentagonPreservingAction->setToolTip(
      tr("Dual Pentagon Preserving Remeshing Mode"));
  connect(mDualPentagonPreservingAction, SIGNAL(triggered()), this,
          SLOT(triggerDualPentagonPreserving()));
  actionList->addAction(mDualPentagonPreservingAction);

  mDualLoopStyleRemeshingSixAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Dual Loop Style"), this);
  mDualLoopStyleRemeshingSixAction->setCheckable(true);
  sm->registerAction(mDualLoopStyleRemeshingSixAction, "Remeshing", "");
  mDualLoopStyleRemeshingSixAction->setStatusTip(
      tr("Enter Loop Style Remeshing Remeshing Mode"));
  mDualLoopStyleRemeshingSixAction->setToolTip(
      tr("Dual Loop Style Remeshing Remeshing Mode"));
  connect(mDualLoopStyleRemeshingSixAction, SIGNAL(triggered()), this,
          SLOT(triggerDualLoopStyleRemeshingSix()));
  actionList->addAction(mDualLoopStyleRemeshingSixAction);

  mLoopStyleRemeshingSixAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Loop Style"), this);
  mLoopStyleRemeshingSixAction->setCheckable(true);
  sm->registerAction(mLoopStyleRemeshingSixAction, "Remeshing", "");
  mLoopStyleRemeshingSixAction->setStatusTip(
      tr("Enter Loop Style Remeshing Remeshing Mode"));
  mLoopStyleRemeshingSixAction->setToolTip(
      tr("Loop Style Remeshing Remeshing Mode"));
  connect(mLoopStyleRemeshingSixAction, SIGNAL(triggered()), this,
          SLOT(triggerLoopStyleRemeshingSix()));
  actionList->addAction(mLoopStyleRemeshingSixAction);

  mFractalAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Fractal"), this);
  ...
  mDoubleStellateMiscAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Double Stellate"), this);
  mDoubleStellateMiscAction->setCheckable(true);
  sm->registerAction(mDoubleStellateMiscAction, "Remeshing", "");
  mDoubleStellateMiscAction->setStatusTip(
      tr("Enter Double Stellate Remeshing Mode"));
  mDoubleStellateMiscAction->setToolTip(tr("Double Stellate Remeshing Mode"));
  connect(mDoubleStellateMiscAction, SIGNAL(triggered()), this,
          SLOT(triggerDoubleStellateMisc()));
  actionList->addAction(mDoubleStellateMiscAction);

  mDooSabinBCAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Doo Sabin BC"), this);
  ...
  connect(mDooSabinBCAction, SIGNAL(triggered()), this,
          SLOT(triggerDooSabinBC()));
  actionList->addAction(mDooSabinBCAction);

  mDooSabinBCNewAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Doo Sabin BC New"), this);
  mDooSabinBCNewAction->setCheckable(true);
  sm->registerAction(mDooSabinBCNewAction, "Remeshing", "");
  mDooSabinBCNewAction->setStatusTip(
      tr("Enter Doo Sabin BC New Remeshing Mode"));
  mDooSabinBCNewAction->setToolTip(tr("Doo Sabin BC New Remeshing Mode"));
  connect(mDooSabinBCNewAction, SIGNAL(triggered()), this,
          SLOT(triggerDooSabinBCNew()));
  actionList->addAction(mDooSabinBCNewAction);

  mDomeAction =
      new QAction(/*QIcon(":images/doosabin_extrude.png"),*/ tr("Dome"), this);
  ...
  mSubdivideFaceAction = new QAction(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Subdivide Face"), this);
  ...
  connect(mSubdivideFaceAction, SIGNAL(triggered()), this,
          SLOT(triggerSubdivideFace()));
...
void RemeshingMode::addActions(QActionGroup *actionGroup, QToolBar *toolBar,
...
void RemeshingMode::setupDual() {
  ...
  connect(dualCreateButton, SIGNAL(clicked()), ((MainWindow *)mParent),
...
void RemeshingMode::setupThreeConversion() {
  ...
  connect(rootThreeCreateButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  connect(triangulateCreateButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  connect(stellationButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  starSpinBox =
      createDoubleSpinBox(mDoubleStellationLayout, starLabel, tr("Offset:"),
                          0.0, 1.0, 0.01, 0.0, 3, 0, 0);
  connect(starSpinBox, SIGNAL(valueChanged(double)), ((MainWindow *)mParent),
          SLOT(changeStarOffset(double)));
  // create button
  starButton = new QPushButton(tr("Perform Remeshing"), this);
  connect(starButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  twelveSixFourSpinBox =
      createDoubleSpinBox(mTwelveSixFourLayout, twelveSixFourLabel,
                          tr("Offset:"), 0.0, 1.0, 0.01, 0.7, 3, 0, 0);
  ...
  connect(twelveSixFourButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  connect(honeycombButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  vertexTruncationSpinBox =
      createDoubleSpinBox(mVertexTruncationLayout, vertexTruncationLabel,
                          tr("Offset:"), 0.0, 0.5, 0.01, 0.25, 3, 0, 0);
  ...
  connect(vertexTruncationButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  dualTwelveSixFourSpinBox =
      createDoubleSpinBox(mDualTwelveSixFourLayout, dualTwelveSixFourLabel,
                          tr("Offset:"), 0.0, 1.0, 0.01, 0.06, 3, 0, 0);
  ...
  connect(dualTwelveSixFourButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
...
void RemeshingMode::setupFourConversion() {
  ...
  connect(linearVertexCreateButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  connect(catmullClarkCreateButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  stellateEdgeRemovalCreateButton =
      new QPushButton(tr("Perform Remeshing"), this);
  ...
  mStellateEdgeRemovalWidget->setWindowTitle(
      tr("Stellate with Edge Removal Remeshing"));
  ...
  connect(dooSabinCheckBox, SIGNAL(stateChanged(int)), ((MainWindow *)mParent),
          SLOT(toggleDooSabinEdgeFlag(int)));
  dooSabinCreateButton = new QPushButton(tr("Perform Remeshing"), this);
  connect(dooSabinCreateButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  cornerCuttingAlphaSpinBox =
      createDoubleSpinBox(mCornerCuttingLayout, cornerCuttingAlphaLabel,
                          tr("Alpha:"), 0.333, .999, 0.01, 0.5625, 3, 0, 0);
  connect(cornerCuttingAlphaSpinBox, SIGNAL(valueChanged(double)),
          ((MainWindow *)mParent), SLOT(changeCornerCuttingAlpha(double)));
  cornerCuttingCreateButton = new QPushButton(tr("Perform Remeshing"), this);
  connect(cornerCuttingCreateButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  modifiedCornerCuttingSpinBox = createDoubleSpinBox(
      mModifiedCornerCuttingLayout, modifiedCornerCuttingLabel,
      tr("Thickness:"), 0.0, 1.0, 0.01, 0.25, 3, 0, 0);
  connect(modifiedCornerCuttingSpinBox, SIGNAL(valueChanged(double)),
          ((MainWindow *)mParent),
          SLOT(changeModifiedCornerCuttingThickness(double)));
  modifiedCornerCuttingCreateButton =
      new QPushButton(tr("Perform Remeshing"), this);
  connect(modifiedCornerCuttingCreateButton, SIGNAL(clicked()),
          ((MainWindow *)mParent), SLOT(performRemeshing()));
  mModifiedCornerCuttingLayout->addWidget(modifiedCornerCuttingCreateButton, 1,
                                          0, 1, 2);
  mModifiedCornerCuttingLayout->setRowStretch(2, 1);
  mModifiedCornerCuttingLayout->setColumnStretch(2, 1);
  mModifiedCornerCuttingWidget->setWindowTitle(
      tr("Modified Corner Cutting Remeshing"));
  ...
  connect(simplestCreateButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
...
void RemeshingMode::triggerLinearVertex() {
  ...
  ((MainWindow *)mParent)
      ->setRemeshingScheme(MainWindow::LinearVertexInsertion);
}
...
void RemeshingMode::triggerModifiedCornerCutting() {
  ...
  ((MainWindow *)mParent)
      ->setRemeshingScheme(MainWindow::ModifiedCornerCutting);
}
...
void RemeshingMode::setupFiveConversion() {
  ...
  pentagonalizationSpinBox =
      createDoubleSpinBox(mPentagonalizationLayout, pentagonalizationLabel,
                          tr("Offset:"), 0.0, 1.0, 0.01, 0.0, 3, 0, 0);
  connect(pentagonalizationSpinBox, SIGNAL(valueChanged(double)),
          ((MainWindow *)mParent), SLOT(changePentagonalOffset(double)));
  // button
  pentagonalizationCreateButton =
      new QPushButton(tr("Perform Remeshing"), this);
  connect(pentagonalizationCreateButton, SIGNAL(clicked()),
          ((MainWindow *)mParent), SLOT(performRemeshing()));
  mPentagonalizationLayout->addWidget(pentagonalizationCreateButton, 1, 0, 1,
                                      2);
  ...
  cubicPentagonalizationSpinBox = createDoubleSpinBox(
      mCubicPentagonalizationLayout, cubicPentagonalizationLabel, tr("Offset:"),
      0.0, 1.0, 0.01, 0.0, 3, 0, 0);
  connect(cubicPentagonalizationSpinBox, SIGNAL(valueChanged(double)),
          ((MainWindow *)mParent), SLOT(changePentagonalOffset(double)));
  cubicPentagonalizationCreateButton =
      new QPushButton(tr("Perform Remeshing"), this);
  ...
  mCubicPentagonalizationWidget->setWindowTitle(
      tr("Cubic Pentagonalization Remeshing"));
  ...
  dualPentagonalizationCreateButton =
      new QPushButton(tr("Perform Remeshing"), this);
  connect(dualPentagonalizationCreateButton, SIGNAL(clicked()),
          ((MainWindow *)mParent), SLOT(performRemeshing()));
  mDualPentagonalizationLayout->addWidget(dualPentagonalizationCreateButton, 0,
                                          0);
  mDualPentagonalizationLayout->setRowStretch(1, 1);
  mDualPentagonalizationLayout->setColumnStretch(2, 1);
  mDualPentagonalizationWidget->setWindowTitle(
      tr("Dual Pentagonalization Remeshing"));
...
void RemeshingMode::setupThreePreservation() {
  ...
  loopStyleRemeshingSpinBox =
      createDoubleSpinBox(mLoopStyleRemeshingLayout, loopStyleRemeshingLabel,
                          tr("Length:"), 0.0, 1.0, 0.01, 1.0, 3, 0, 0);
  connect(loopStyleRemeshingSpinBox, SIGNAL(valueChanged(double)),
          ((MainWindow *)mParent),
          SLOT(changeLoopStyleSubdivisionLength(double)));
  loopStyleRemeshingButton = new QPushButton(tr("Perform Remeshing"), this);
  connect(loopStyleRemeshingButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  dualLoopStyleRemeshingTwistSpinBox = createDoubleSpinBox(
      mDualLoopStyleRemeshingLayout, dualLoopStyleRemeshingTwistLabel,
      tr("Twist:"), 0.0, 1.0, 0.01, 0.0, 3, 0, 0);
  ...
  dualLoopStyleRemeshingWeightSpinBox = createDoubleSpinBox(
      mDualLoopStyleRemeshingLayout, dualLoopStyleRemeshingWeightLabel,
      tr("Weight:"), 0.0, 1.0, 0.01, 0.0, 3, 1, 0);
  ...
  connect(dualLoopStyleRemeshingButton, SIGNAL(clicked()),
          ((MainWindow *)mParent), SLOT(performRemeshing()));
  mDualLoopStyleRemeshingLayout->addWidget(dualLoopStyleRemeshingButton, 2, 0,
                                           1, 2);
  mDualLoopStyleRemeshingLayout->setRowStretch(3, 1);
  mDualLoopStyleRemeshingLayout->setColumnStretch(2, 1);
  mDualLoopStyleRemeshingWidget->setWindowTitle(
      tr("Dual Loop Style Remeshing"));
  ...
  dualLoopSubdivisionCreateButton =
      new QPushButton(tr("Perform Remeshing"), this);
  ...
  mDualLoopSubdivisionWidget->setWindowTitle(
      tr("Dual Loop Subdivision Remeshing"));
...
void RemeshingMode::setupFourPreservation() {
  ...
  connect(globalExtrudeButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  connect(checkerboardCreateButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  connect(dualGlobalExtrudeButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
...
void RemeshingMode::triggerDualGlobalExtrude() {
  ...
  ((MainWindow *)mParent)
      ->setRemeshingScheme(MainWindow::DualGlobalCubicExtrude);
}
...
void RemeshingMode::setupFivePreservation() {
  ...
  pentagonPreservingSpinBox =
      createDoubleSpinBox(mPentagonPreservingLayout, pentagonPreservingLabel,
                          tr("Scale Factor:"), 0.0, 1.0, 0.01, 0.75, 3, 0, 0);
  ...
  connect(pentagonPreservingButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  mPentagonPreservingWidget->setWindowTitle(
      tr("Pentagon Preserving Remeshing"));
  ...
  mDualPentagonPreservingWidget->setWindowTitle(
      tr("Dual Pentagon Preserving Remeshing"));
...
void RemeshingMode::triggerDualPentagonPreserving() {
  ...
  ((MainWindow *)mParent)
      ->setRemeshingScheme(MainWindow::DualPentagonPreserving);
}
...
void RemeshingMode::setupSixPreservation() {
  ...
  dualLoopStyleRemeshingSixTwistSpinBox = createDoubleSpinBox(
      mDualLoopStyleRemeshingSixLayout, dualLoopStyleRemeshingSixTwistLabel,
      tr("Twist:"), 0.0, 1.0, 0.01, 0.0, 3, 0, 0);
  ...
  dualLoopStyleRemeshingSixWeightSpinBox = createDoubleSpinBox(
      mDualLoopStyleRemeshingLayout, dualLoopStyleRemeshingSixWeightLabel,
      tr("Weight:"), 0.0, 1.0, 0.01, 0.0, 3, 1, 0);
  connect(dualLoopStyleRemeshingSixWeightSpinBox, SIGNAL(valueChanged(double)),
          ((MainWindow *)mParent), SLOT(changeRoot4Weight(double)));
  dualLoopStyleRemeshingSixButton =
      new QPushButton(tr("Perform Remeshing"), this);
  ...
  mDualLoopStyleRemeshingSixWidget->setWindowTitle(
      tr("Dual Loop Style Six Remeshing"));
  ...
  loopStyleRemeshingSixSpinBox = createDoubleSpinBox(
      mLoopStyleRemeshingSixLayout, loopStyleRemeshingSixLabel, tr("Length:"),
      0.0, 1.0, 0.01, 1.0, 3, 0, 0);
  ...
  connect(loopStyleRemeshingSixButton, SIGNAL(clicked()),
          ((MainWindow *)mParent), SLOT(performRemeshing()));
  mLoopStyleRemeshingSixLayout->addWidget(loopStyleRemeshingSixButton, 1, 0, 1,
                                          2);
...
void RemeshingMode::triggerLoopStyleRemeshingSix() {
  ...
  ((MainWindow *)mParent)
      ->setRemeshingScheme(MainWindow::DualHexagonPreserving);
}
...
void RemeshingMode::setupMiscellaneous() {
  ...
  fractalMultiplierSpinBox =
      createDoubleSpinBox(mFractalLayout, fractalMultiplierLabel,
                          tr("Multiplier:"), 0.0, 2.0, 0.01, 1.0, 3, 0, 0);
  ...
  connect(fractalButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  doubleStellateMiscHeightSpinBox = createDoubleSpinBox(
      mDoubleStellateMiscLayout, doubleStellateMiscHeightLabel, tr("Height:"),
      -1.0, 1.0, 0.01, 0.0, 3, 0, 0);
  ...
  doubleStellateMiscCurveSpinBox = createDoubleSpinBox(
      mDoubleStellateMiscLayout, doubleStellateMiscCurveLabel, tr("Curve:"),
      -1.0, 1.0, 0.01, 0.0, 3, 1, 0);
  ...
  connect(doubleStellateMiscButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  connect(dooSabinBCButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  dooSabinBCNewScaleSpinBox =
      createDoubleSpinBox(mDooSabinBCNewLayout, dooSabinBCNewScaleLabel,
                          tr("Scale:"), 0.0, 2.0, 0.01, 1.0, 3, 0, 0);
  ...
  dooSabinBCNewLengthSpinBox =
      createDoubleSpinBox(mDooSabinBCNewLayout, dooSabinBCNewLengthLabel,
                          tr("Length:"), 0.0, 1.0, 0.01, 1.0, 3, 1, 0);
  ...
  connect(dooSabinBCNewButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  domeHeightSpinBox =
      createDoubleSpinBox(mDomeLayout, domeHeightLabel, tr("Height:"), 0.0, 2.0,
                          0.01, 1.0, 3, 0, 0);
  ...
  domeScaleSpinBox = createDoubleSpinBox(
      mDomeLayout, domeScaleLabel, tr("Scale:"), 0.0, 2.0, 0.01, 1.0, 3, 1, 0);
  ...
  connect(domeButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performRemeshing()));
  ...
  connect(subdivideFaceButton, SIGNAL(clicked()), ((MainWindow *)mParent),
...
void RemeshingMode::triggerDoubleStellateMisc() {
  ...
  ((MainWindow *)mParent)
      ->setRemeshingScheme(MainWindow::ModifiedDoubleStellate);
}
...
void RemeshingMode::retranslateUi() {
  ...
  mDualAction->setStatusTip(tr("Enter Dual Remeshing Mode"));
  mDualAction->setToolTip(tr("Dual Remeshing Mode"));
  mRootThreeAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Root-3"));
  mRootThreeAction->setStatusTip(tr("Enter Root-3 Remeshing Mode"));
  mRootThreeAction->setToolTip(tr("Root-3 Remeshing Mode"));
  mTriangulateAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Triangulate"));
  mTriangulateAction->setStatusTip(tr("Enter Triangulate Remeshing Mode"));
  mTriangulateAction->setToolTip(tr("Triangulate Remeshing Mode"));
  mDualVertexTruncationAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Dual Vertex Truncation"));
  mDualVertexTruncationAction->setStatusTip(
      tr("Enter Dual Vertex Truncation Remeshing Mode"));
  mDualVertexTruncationAction->setToolTip(
      tr("Dual Vertex Truncation Remeshing Mode"));
  mStellationAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Stellate"));
  mStellationAction->setStatusTip(tr("Enter Stellate Remeshing Mode"));
  mStellationAction->setToolTip(tr("Stellate Remeshing Mode"));
  mDoubleStellationAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Double Stellate"));
  mDoubleStellationAction->setStatusTip(
      tr("Enter Double Stellate Remeshing Mode"));
  mDoubleStellationAction->setToolTip(tr("Double Stellate Remeshing Mode"));
  mTwelveSixFourAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("12.6.4"));
  mTwelveSixFourAction->setStatusTip(tr("Enter 12.6.4 Remeshing Mode"));
  mTwelveSixFourAction->setToolTip(tr("12.6.4 Remeshing Mode"));
  mHoneycombAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Honeycomb"));
  mHoneycombAction->setStatusTip(tr("Enter Honeycomb Remeshing Mode"));
  mHoneycombAction->setToolTip(tr("Honeycomb Remeshing Mode"));
  mVertexTruncationAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Vertex Truncation"));
  mVertexTruncationAction->setStatusTip(
      tr("Enter Vertex Truncation Remeshing Mode"));
  mVertexTruncationAction->setToolTip(tr("Vertex Truncation Remeshing Mode"));
  mDualTwelveSixFourAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Dual 12.6.4"));
  mDualTwelveSixFourAction->setStatusTip(
      tr("Enter Dual 12.6.4 Remeshing Mode"));
  mDualTwelveSixFourAction->setToolTip(tr("Dual 12.6.4 Remeshing Mode"));
  mLinearVertexAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Linear Vertex Insertion"));
  mLinearVertexAction->setStatusTip(
      tr("Enter Linear Vertex Insertion Remeshing Mode"));
  mLinearVertexAction->setToolTip(tr("Linear Vertex Insertion Remeshing Mode"));
  mCatmullClarkAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Catmull Clark"));
  mCatmullClarkAction->setStatusTip(tr("Enter Catmull Clark Remeshing Mode"));
  mCatmullClarkAction->setToolTip(tr("Catmull Clark Remeshing Mode"));
  mStellateEdgeRemovalAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr(
          "Stellate with Edge Removal"));
  mStellateEdgeRemovalAction->setStatusTip(
      tr("Enter Stellate with Edge Removal Remeshing Mode"));
  mStellateEdgeRemovalAction->setToolTip(
      tr("Stellate with Edge Removal Remeshing Mode"));
  mDooSabinAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Doo Sabin"));
  mDooSabinAction->setStatusTip(tr("Enter Doo Sabin Remeshing Mode"));
  mDooSabinAction->setToolTip(tr("Doo Sabin Remeshing Mode"));
  mCornerCuttingAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Corner Cutting"));
  mCornerCuttingAction->setStatusTip(tr("Enter Corner Cutting Remeshing Mode"));
  mCornerCuttingAction->setToolTip(tr("Corner Cutting Remeshing Mode"));
  mModifiedCornerCuttingAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Modified Corner Cutting"));
  mModifiedCornerCuttingAction->setStatusTip(
      tr("Enter Modified Corner Cutting Remeshing Mode"));
  mModifiedCornerCuttingAction->setToolTip(
      tr("Modified Corner Cutting Remeshing Mode"));
  mSimplestAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Simplest"));
  mSimplestAction->setStatusTip(tr("Enter Simplest Remeshing Mode"));
  mSimplestAction->setToolTip(tr("Simplest Remeshing Mode"));
  mPentagonalizationAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Pentagonalization"));
  mPentagonalizationAction->setStatusTip(
      tr("Enter Pentagonalization Remeshing Mode"));
  mPentagonalizationAction->setToolTip(tr("Pentagonalization Remeshing Mode"));
  mCubicPentagonalizationAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Cubic Pentagonalization"));
  mCubicPentagonalizationAction->setStatusTip(
      tr("Enter Cubic Pentagonalization Remeshing Mode"));
  mCubicPentagonalizationAction->setToolTip(
      tr("Cubic Pentagonalization Remeshing Mode"));
  mDualPentagonalizationAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Dual Pentagonalization"));
  mDualPentagonalizationAction->setStatusTip(
      tr("Enter Dual Pentagonalization Remeshing Mode"));
  mDualPentagonalizationAction->setToolTip(
      tr("Dual Pentagonalization Remeshing Mode"));
  mLoopStyleRemeshingAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Loop Style Remeshing"));
  mLoopStyleRemeshingAction->setStatusTip(
      tr("Enter Loop Style Remeshing Remeshing Mode"));
  mLoopStyleRemeshingAction->setToolTip(
      tr("Loop Style Remeshing Remeshing Mode"));
  mLoopSubdivisionAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Loop Subdivision"));
  mLoopSubdivisionAction->setStatusTip(
      tr("Enter Loop Subdivision Remeshing Mode"));
  mLoopSubdivisionAction->setToolTip(tr("Loop Subdivision Remeshing Mode"));
  mDualLoopStyleRemeshingAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr(
          "Dual Loop Style Remeshing"));
  mDualLoopStyleRemeshingAction->setStatusTip(
      tr("Enter Dual Loop Style Remeshing Remeshing Mode"));
  mDualLoopStyleRemeshingAction->setToolTip(
      tr("Dual Loop Style Remeshing Remeshing Mode"));
  mDualLoopSubdivisionAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Dual Loop Subdivision"));
  mDualLoopSubdivisionAction->setStatusTip(
      tr("Enter Dual Loop Subdivision Remeshing Mode"));
  mDualLoopSubdivisionAction->setToolTip(
      tr("Dual Loop Subdivision Remeshing Mode"));
  mGlobalExtrudeAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Global Extrude"));
  mGlobalExtrudeAction->setStatusTip(tr("Enter Global Extrude Remeshing Mode"));
  mGlobalExtrudeAction->setToolTip(tr("Global Extrude Remeshing Mode"));
  mCheckerboardAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Checkerboard"));
  mCheckerboardAction->setStatusTip(tr("Enter Checkerboard Remeshing Mode"));
  mCheckerboardAction->setToolTip(tr("Checkerboard Remeshing Mode"));
  mDualGlobalExtrudeAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Dual Global Extrude"));
  mDualGlobalExtrudeAction->setStatusTip(
      tr("Enter Dual Global Extrude Remeshing Mode"));
  mDualGlobalExtrudeAction->setToolTip(
      tr("Dual Global Extrude Remeshing Mode"));
  mDualCheckerboardAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Dual Checkerboard"));
  mDualCheckerboardAction->setStatusTip(
      tr("Enter Dual Checkerboard Remeshing Mode"));
  mDualCheckerboardAction->setToolTip(tr("Dual Checkerboard Remeshing Mode"));
  mPentagonPreservingAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Pentagon Preserving"));
  mPentagonPreservingAction->setStatusTip(
      tr("Enter Pentagon Preserving Remeshing Mode"));
  mPentagonPreservingAction->setToolTip(
      tr("Pentagon Preserving Remeshing Mode"));
  mDualPentagonPreservingAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr(
          "Dual Pentagon Preserving"));
  mDualPentagonPreservingAction->setStatusTip(
      tr("Enter Dual Pentagon Preserving Remeshing Mode"));
  mDualPentagonPreservingAction->setToolTip(
      tr("Dual Pentagon Preserving Remeshing Mode"));
  mDualLoopStyleRemeshingSixAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Dual Loop Style"));
  mDualLoopStyleRemeshingSixAction->setStatusTip(
      tr("Enter Loop Style Remeshing Remeshing Mode"));
  mDualLoopStyleRemeshingSixAction->setToolTip(
      tr("Dual Loop Style Remeshing Remeshing Mode"));
  mLoopStyleRemeshingSixAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Loop Style"));
  mLoopStyleRemeshingSixAction->setStatusTip(
      tr("Enter Loop Style Remeshing Remeshing Mode"));
  mLoopStyleRemeshingSixAction->setToolTip(
      tr("Loop Style Remeshing Remeshing Mode"));
  mFractalAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Fractal"));
  mFractalAction->setStatusTip(tr("Enter Fractal Remeshing Mode"));
  mFractalAction->setToolTip(tr("Fractal Remeshing Mode"));
  mDoubleStellateMiscAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Double Stellate"));
  mDoubleStellateMiscAction->setStatusTip(
      tr("Enter Double Stellate Remeshing Mode"));
  mDoubleStellateMiscAction->setToolTip(tr("Double Stellate Remeshing Mode"));
  mDooSabinBCAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Doo Sabin BC"));
  mDooSabinBCAction->setStatusTip(tr("Enter Doo Sabin BC Remeshing Mode"));
  mDooSabinBCAction->setToolTip(tr("Doo Sabin BC Remeshing Mode"));
  mDooSabinBCNewAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Doo Sabin BC New"));
  mDooSabinBCNewAction->setStatusTip(
      tr("Enter Doo Sabin BC New Remeshing Mode"));
  mDooSabinBCNewAction->setToolTip(tr("Doo Sabin BC New Remeshing Mode"));
  ...
  mDomeAction->setStatusTip(tr("Enter Dome Remeshing Mode"));
  mDomeAction->setToolTip(tr("Dome Remeshing Mode"));
  mSubdivideFaceAction->setText(
      /*QIcon(":images/doosabin_extrude.png"),*/ tr("Subdivide Face"));
  mSubdivideFaceAction->setStatusTip(tr("Enter Subdivide Face Remeshing Mode"));
  mSubdivideFaceAction->setToolTip(tr("Subdivide Face Remeshing Mode"));
  // qmenus titles
  ...
  // widgets and stuff
  //!< \todo add buttons and spinbox labels to retranslate function for
  //!< remeshingmode.cc .. .done i think... dave
