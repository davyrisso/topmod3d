...
void renderVerticesForSelect(DLFLObjectPtr obj) {
  ...
  // number of vertices
  DLFLObject::vparray.reserve(
      vertex_list.size()); // STL checks for current capacity
...
void renderEdgesForSelect(DLFLObjectPtr obj) {
  ...
  // Adjust the size of the array used for selection to be atleast equal to
  // number of edges
  DLFLObject::eparray.reserve(
      edge_list.size()); // STL checks for current capacity
...
void renderFacesForSelect(DLFLObjectPtr obj, bool transparent) {
  ...
  // Adjust the size of the array used for selection to be atleast equal to
  // number of faces
  DLFLObject::fparray.reserve(
      face_list.size()); // STL checks for current capacity
