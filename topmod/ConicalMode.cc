...
ConicalMode::ConicalMode(QWidget *parent, QShortcutManager *sm)
  ...
  mCutbyEdgeAction = new QAction(QIcon(":images/sculpting-cutedges.png"),
                                 tr("Cut by Edge"), this);
  ...
  connect(mCutbyEdgeAction, SIGNAL(triggered()), this,
          SLOT(triggerCutbyEdge()));

  mCutbyVertexAction = new QAction(QIcon(":images/sculpting-cutvertices.png"),
                                   tr("Cut by Vertex"), this);
  ...
  connect(mCutbyVertexAction, SIGNAL(triggered()), this,
          SLOT(triggerCutbyVertex()));

  // mCutbyEdgeVertexAction = new QAction(QIcon(":images/prim_cube.png"),tr("Cut
  // by Edge-Vertex"),this); mCutbyEdgeVertexAction->setCheckable(true);
  ...
  // connect(mCutbyEdgeVertexAction, SIGNAL(triggered()), this,
  // SLOT(triggerCutbyEdgeVertex()));

  mCutbyFaceAction = new QAction(QIcon(":images/sculpting-cutfaces.png"),
                                 tr("Cut by Face"), this);
  ...
  connect(mCutbyFaceAction, SIGNAL(triggered()), this,
          SLOT(triggerCutbyFace()));

  // mTruncateEdgeAction = new
  // QAction(QIcon(":images/prim_cube.png"),tr("Truncate Edge"),this);
  ...
  // connect(mTruncateEdgeAction, SIGNAL(triggered()), this,
  // SLOT(triggerTruncateEdge()));
  //
  // mTruncateVertexAction = new
  // QAction(QIcon(":images/prim_cube.png"),tr("Truncate Vertex"),this);
  ...
  // connect(mTruncateVertexAction, SIGNAL(triggered()), this,
  // SLOT(triggerTruncateVertex()));
  //
  mDualConvexHullAction =
      new QAction(QIcon(":images/prim_cube.png"), tr("Dual Convex Hull"), this);
  ...
  connect(mDualConvexHullAction, SIGNAL(triggered()), this,
          SLOT(triggerDualConvexHull()));
}
...
void ConicalMode::addActions(QActionGroup *actionGroup, QToolBar *toolBar,
...
void ConicalMode::setupCutbyEdge() {
  ...
  cutbyEdgeOffsetSpinBox =
      createDoubleSpinBox(mCutbyEdgeLayout, cutbyEdgeOffsetLabel, tr("Offset:"),
                          0.0, 2.0, 0.01, 0.25, 3, 0, 0);
  connect(cutbyEdgeOffsetSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(changeCutOffsetE(double)));

  cutbyEdgeGlobalCheckBox = new QCheckBox(tr("Global Cut"), this);
  cutbyEdgeGlobalCheckBox->setChecked(Qt::Unchecked);
  connect(cutbyEdgeGlobalCheckBox, SIGNAL(stateChanged(int)), this,
          SLOT(toggleGlobalCut(int)));
  ...
  connect(performCuttingEdgeButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performCutting()));
  ...
  //
  //
  // cutbyEdgeCutSelectedCheckBox = new QCheckBox(tr("cut selected
  // edges"),this); cutbyEdgeCutSelectedCheckBox->setChecked(Qt::Checked);
  ...
  //
  // QPushButton *performCuttingButton = new QPushButton(tr("Perform Cutting"),
  // this); connect(performCuttingButton, SIGNAL(clicked()),
...
void ConicalMode::setupCutbyVertex() {
  ...
  cutbyVertexOffsetSpinBox =
      createDoubleSpinBox(mCutbyVertexLayout, cutbyVertexOffsetLabel,
                          tr("Offset:"), 0.0, 2.0, 0.01, 0.25, 3, 0, 0);
  connect(cutbyVertexOffsetSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(changeCutOffsetV(double)));

  cutbyVertexGlobalCheckBox = new QCheckBox(tr("Global Cut"), this);
  cutbyVertexGlobalCheckBox->setChecked(Qt::Unchecked);
  connect(cutbyVertexGlobalCheckBox, SIGNAL(stateChanged(int)), this,
          SLOT(toggleGlobalCut(int)));
  ...
  connect(performCuttingVertexButton, SIGNAL(clicked()),
          ((MainWindow *)mParent), SLOT(performCutting()));
  ...
  //
  // cutbyVertexCutSelectedCheckBox = new QCheckBox(tr("cut selected
  // edges"),this); cutbyVertexCutSelectedCheckBox->setChecked(Qt::Checked);
...
void ConicalMode::setupCutbyEdgeVertex() {
  ...
  //
  // cutbyEdgeVertexCutSelectedCheckBox = new QCheckBox(tr("cut selected
  // edges"),this); cutbyEdgeVertexCutSelectedCheckBox->setChecked(Qt::Checked);
...
void ConicalMode::setupCutbyFace() {
  ...
  cutbyFaceOffsetSpinBox =
      createDoubleSpinBox(mCutbyFaceLayout, cutbyFaceOffsetLabel, tr("Offset:"),
                          0.0, 2.0, 0.01, 0.25, 3, 0, 0);
  connect(cutbyFaceOffsetSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(changeCutOffsetE(double)));

  cutbyFaceGlobalCheckBox = new QCheckBox(tr("Global Cut"), this);
  cutbyFaceGlobalCheckBox->setChecked(Qt::Unchecked);
  connect(cutbyFaceGlobalCheckBox, SIGNAL(stateChanged(int)), this,
          SLOT(toggleGlobalCut(int)));
  ...
  connect(performCuttingFaceButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(performCutting()));
  ...
  //
  // cutbyFaceCutSelectedCheckBox = new QCheckBox(tr("cut selected
  // faces"),this); cutbyFaceCutSelectedCheckBox->setChecked(Qt::Checked);
...
void ConicalMode::setupTruncateEdge() {
  ...
  //
  // truncateEdgeCutSelectedCheckBox = new QCheckBox(tr("cut selected
  // vertices"),this); truncateEdgeCutSelectedCheckBox->setChecked(Qt::Checked);
...
void ConicalMode::setupTruncateVertex() {
  ...
  //
  // truncateVertexCutSelectedCheckBox = new QCheckBox(tr("cut selected
  // vertices"),this);
...
void ConicalMode::setupDualConvexHull() {
  ...
  connect(convexHullButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(createConvexHull()));
  ...
  connect(dualConvexHullButton, SIGNAL(clicked()), ((MainWindow *)mParent),
          SLOT(createDualConvexHull()));
