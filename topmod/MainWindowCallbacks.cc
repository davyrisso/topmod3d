...
void MainWindow::changeNormalTwistingFactor(int factor)//Saied
{
    ...
    qDebug()  << "normal twist factor: " << QString::number(MainWindow::normal_twist_factor, 'g', 8);
}
...
void MainWindow::applyBranchCovering3v(const std::vector<HALF_EDGE_MAPPING> &mapping_guid, const BranchCovering_CornerCutting_Parameters &parameters)
{
