 ...
 *
 * Welcome to the TopMod source code documentation. Here you will find
 * descriptions of all the Namespaces, Classes, and other variables defined in
 * the TopMod source code. This documentation was generated by Doxygen directly
 * from the comments in the source code. Please see the "Related Pages" section
 * for a Todo List of things that currently need to be implemented or completed
...
int TdxComputeAxes(const TdxDeviceAxes inArrayPtr)
{
    ...
    // sprintf(st, "(%hd, %hd, %hd)", inArrayPtr[0], inArrayPtr[1],
inArrayPtr[2]);
    ...
    // sprintf(st, "(%hd, %hd, %hd)", inArrayPtr[3], inArrayPtr[4],
inArrayPtr[5]);
    // txt = CFStringCreateWithCString(NULL, st, kCFStringEncodingUTF8);
...
int main(int argc, char *argv[]) {
  ...
  app.processEvents();
  // app.setMainWindow();
  app.setWindowIcon(QIcon(":/images/topmod.png"));
  QApplication::setWindowIcon(QIcon(":/images/topmod.png"));

  // this is a preliminary version of a splash screen functionality.
  // the app opens so quickly it is hardly shown, so i will consider adding a
  // delay
  ...
  //  OSStatus err;
  //  err = TdxInitDevice('TopM', TRUE, kConnexionClientModeTakeOver,
  //  kConnexionMaskAll);
  // pass kConnexionClientModeTakeOver as the mode and try kConnexionMaskAxis |
  // kConnexionMaskButtons as the mask. kConnexionMaskAll should also work.
#endif
#endif
